    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        if (pathReference == null) {
            ...
            StorageReference submitProfile1 = storageReference.child("image_store" + day + "/asd1.jpeg");
            StorageReference submitProfile2 = storageReference.child("image_store" + day + "/asd2.jpeg");
            StorageReference submitProfile3 = storageReference.child("image_store" + day + "/asd3.jpeg");
            StorageReference submitProfile4 = storageReference.child("image_store" + day + "/asd4.jpeg");
        ...
        findDayBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (pathReference == null) {
                    ...
                    StorageReference submitProfile1 = storageReference.child("image_store" + diagnosisDay + "/asd1.jpeg");
                    StorageReference submitProfile2 = storageReference.child("image_store" + diagnosisDay + "/asd2.jpeg");
                    StorageReference submitProfile3 = storageReference.child("image_store" + diagnosisDay + "/asd3.jpeg");
                    StorageReference submitProfile4 = storageReference.child("image_store" + diagnosisDay + "/asd4.jpeg");
